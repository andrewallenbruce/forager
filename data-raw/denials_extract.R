...
deny_a <- read_xlsx(
  "D:/medical_ins_large_claims/rcm_kit_ar_aging_denials/Denials Data/DenialsExtract_FacilityA.xlsx"
) |>
  clean_names() |>
  mutate(
...
deny_b <- read_xlsx(
  "D:/medical_ins_large_claims/rcm_kit_ar_aging_denials/Denials Data/DenialsExtract_FacilityB.xlsx"
) |>
  clean_names() |>
  mutate(
    period = as_date(period),
...
denials_extract <- get_pin("denials_extract")
