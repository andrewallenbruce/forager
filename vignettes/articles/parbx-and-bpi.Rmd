...
I’ll generate some random weights to add to each month. The probs() function from the wakefield package will generate a set of x numbers, the sum of which will be equal to one. I’ll put these into a new data frame, merge the two data frames, then create a new “Weighted PARBx
” column:
