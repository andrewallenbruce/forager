...
#
# rcm_year |>
#   dplyr::mutate(earb_abs = earb - dplyr::lag(earb)) |>
#   dplyr::mutate(earb_rel = (earb_abs / dplyr::lag(earb))) |>
#   dplyr::mutate(earb_abs = dplyr::coalesce(earb_abs, 0),
#                 earb_rel = dplyr::coalesce(earb_rel, 0)) |>
#   dplyr::mutate(earb_rel = janitor::round_half_up(earb_rel, digits = 5))
