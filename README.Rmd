...
```{r echo=FALSE}
dar_month_2022 |> dplyr::select(month, gct, earb, earb_trg, dar, pass) |> knitr::kable(col.names = c("Month", "Gross Charges", "Ending AR", "Target AR", "Days in AR", "Pass"))
```
...
![](man/figures/gt_1.png){width="100%"}
...
![](man/figures/gt_2.png){width="100%"}
